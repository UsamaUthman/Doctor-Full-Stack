            ...
            <div>
              <div className="lg:w-[570px] ">
                ...
                <p className="text-[16px] leading-[26px] text-textColor font-[400] mt-[20px]">
                  ...
                  dolorum voluptas quas quod quibusdam natus doloribus. Quisquam
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[50px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px">
                <h2 className="text-[20px] text-center leading-[30px] text-headingColor font-[700] md:text-[30px] md:leading-[40px] ">
                  Find a Doctor
                </h2>
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              <h2 className="heading">We Provide High Quality Services</h2>
